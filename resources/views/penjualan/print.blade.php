...
<body class="A4 potrait">
    ...
    @foreach ($penjualan->chunk(25) as $chunk)
        ...
        <table class="table table-bordered mt-4">
            <thead>
                <tr>
                    ...
                    <th class="border">Tanggal Penjualan</th>
            ...
            <tbody>
                @foreach($chunk as $item)
                    <tr>
                        ...
                        <td class="border">{{ $item->tgl_penjualan }}</td>
                        ...
                        <td class="border">{{ $item->harga_jual }}</td>
                        <td class="border">{{ $item->qty }}</td>
                        <td class="border">Rp {{ number_format(str_replace(".", "", $item->harga_jual) * $item->perhiasan->berat * $item->qty, 0, ',', '.') }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
